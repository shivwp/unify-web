          ...
          <Table>
            <thead>
              <tr>
                ...
                <th className="track_th_hme d-flex align-items-center minwidth210px_ttracker">
                  Members
                </th>
                <th className="w-8">
                ...
                <td className="">
                  <div className="d-flex justify-content-center cewi_trak align-items-center">
                    <svg
                      ...
                      width="11.787"
                      height="6.894"
                      viewBox="0 0 11.787 6.894"
                    >
                      <path
                        id="arrow"
                        d="M17.459,11.5l-4.479,4.479L8.5,11.5"
                ...
                <td className="">
                  <div className="d-flex justify-content-center cewi_trak align-items-center">
                    <svg
                      ...
                      width="6.894"
                      height="11.787"
                      viewBox="0 0 6.894 11.787"
                    >
                      <path
                        id="arrow"
                        d="M8.959,4.479,4.479,0,0,4.479"
                        transform="translate(5.894 1.414) rotate(90)"
                        fill="none"
                        stroke="#221d2d"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    <div className="ewon_track_rc">
                      ...
                      >
                        <path
                          ...
                          d="M10.875,3.375a7.5,7.5,0,1,0,7.5,7.5A7.5,7.5,0,0,0,10.875,3.375ZM14.715,8.8,9.894,13.644h0a.651.651,0,0,1-.418.2.631.631,0,0,1-.422-.206L7.031,11.618a.144.144,0,0,1,0-.206l.642-.642a.139.139,0,0,1,.2,0l1.6,1.6,4.4-4.431a.142.142,0,0,1,.1-.043h0a.131.131,0,0,1,.1.043l.631.653A.142.142,0,0,1,14.715,8.8Z"
                    ...
                    <div className="ewon_track_rc">
                      ...
                      >
                        <path
                          ...
                          d="M10.75,3a7.75,7.75,0,1,0,7.75,7.75A7.743,7.743,0,0,0,10.75,3Zm3.875,10.532-1.093,1.093L10.75,11.843,7.968,14.625,6.875,13.532,9.657,10.75,6.875,7.968,7.968,6.875,10.75,9.657l2.782-2.782,1.093,1.093L11.843,10.75Z"
                          transform="translate(-3 -3)"
                          fill="#e93a46"
                        />
                      </svg>
