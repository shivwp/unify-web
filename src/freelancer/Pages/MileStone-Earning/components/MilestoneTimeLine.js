          ...
          <div className="milestone_timeline">
            ...
            <div className="progress_steps" id="progress_step1">
              ...
              <div className="about_step">
                ...
                on the website. Certain type of users could suggest youtube
                videos to add to that website-side list. See Website:
                https://www.nextjam.live/beta Language: PHP Platform: Wordpress
                How is the website used?. people join or create room share
                people can share video/song that will be played live. There are
                various use cases including the case where we are playing a
                media while in a room that is not live Here is an old demo of
                how the site worked before updates: https://vimeo.com/705725020
                (See the attached requirement) Summary of requirement: . ... If
                this job is well handled, you could be awarded a future job for
                this project as there is more work to do. Interested to work on
                this job? Please apply. Thanks, Lamine.
            ...
            <div className="progress_steps" id="progress_step2">
              ...
              <div className="about_step">
                ...
                play youtube videos from a list (not a youtube playlist ) stored
                on the website. Certain type of users could suggest youtube
                videos to add to that website-side list.
                <div className="paid_btn">
                  <button>Paid</button>
                </div>
              </div>
