        ...
        <Col lg={8}>
          ...
          <div className="unify_service_fee">
            <div className="heading">
              ...
              <span className="amt">
                ${((totalPrice / 100) * project_data?.service_fee)?.toFixed(2)}
              </span>
            </div>
            <div className="desc">
          ...
          <div className="you_will_recive">
            <div className="heading">
              ...
              <span className="amt">
                ...
                {(
                  totalPrice -
                  (totalPrice / 100) * project_data?.service_fee
                )?.toFixed(2)}
              </span>
            </div>
            <div className="desc">
                ...
                <Row>
                  <Col md={4}>
                    <select
                      ...
                      id="project_duration"
                      value={proposal_data?.project_duration}
                      onChange={(e) => {
                        setValues({
                          ...values,
