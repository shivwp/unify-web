          ...
          <Col lg={9}>
            <div className="s_nav_body">
              <div className="s_b_head no-border">
                <h2 className="f-size-35">My Stats</h2>
              </div>
              <div className="r-box_setting">
                <div className="head_mystat_h2">
                ...
                <Row>
                  <Col lg={4}>
                        ...
                        >
                          ...
                          <g id="crown" transform="translate(261 549)">
                            <path
                              id="Path_4471"
                              data-name="Path 4471"
                              d="M12.5,0A12.5,12.5,0,1,0,25,12.5,12.514,12.514,0,0,0,12.5,0Zm7.28,10.463-1.132,6.6a.781.781,0,0,1-.77.649H7.122a.781.781,0,0,1-.77-.649l-1.132-6.6a.781.781,0,0,1,1.112-.834L9.347,11.1l2.471-4.445a.812.812,0,0,1,1.366,0L15.654,11.1l3.015-1.468a.78.78,0,0,1,1.111.834Z"
                              fill="#0edf3f"
                            />
                          </g>
                        </g>
                    ...
                    <div className="mystst_sm_ceq mt-2">
                      Last updated Aug 10
                    </div>
                  </Col>
                  <Col lg={8}>
              ...
              <div className="r-box_setting pb-4">
                <div className="head_mystat_h2 mb-0">
                  <h2 className="mb-0">Do you qualify for Top Rated Plus?</h2>
                </div>
                <div className="mystst_sm_ceq mb-0">
                ...
                <div className="mystst_sm_ceq mt-2 lne_height_stst_nrm">
                  <svg
                    ...
                    width="21"
                    height="14.897"
                    viewBox="0 0 24 17.897"
                  >
                    <path
                      id="Icon_awesome-check"
                      data-name="Icon awesome-check"
                      d="M8.151,22.123l-7.8-7.8a1.2,1.2,0,0,1,0-1.7l1.7-1.7a1.2,1.2,0,0,1,1.7,0L9,16.183,20.254,4.929a1.2,1.2,0,0,1,1.7,0l1.7,1.7a1.2,1.2,0,0,1,0,1.7l-13.8,13.8A1.2,1.2,0,0,1,8.151,22.123Z"
                ...
                <div className="mystst_sm_ceq lne_height_stst_nrm">
                  ...
                  Earned over $800.00 in the past 12 month
                </div>
                <div className="mystst_sm_ceq lne_height_stst_nrm">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  worked on a large contract in past 12 month
                </div>
              </div>
              <div className="r-box_setting pb-4">
                <div className="head_mystat_h2 mb-0">
                  <h2 className="mb-0">Communication</h2>
                </div>
                <div className="mystst_sm_ceq mb-0 mt-2">
                  You <b>replied to 223 fo 234 invitations to apply</b> in the
                  past 90 days
                </div>
                <div>
                  <div className="mys_stst_flex mt-2 mb-3 flex-wrap">
                    <div className="mstat_lbel">Responsiveness</div>
                    <div className="mstat_bxsal">
