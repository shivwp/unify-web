      ...
      <Row>
        <Col md={12} lg={12}>
          <div className="timesheetDetails">
            <div className="single_active_proposal">
              <div className="sep_bdr no-border">
                <div className="messages">
                  <div className="heading">Jolly Smith</div>
                  <div className="seeTimeSheetContent">
                    <div className="left">
                      <div className="about">
                        <span className="seeTimesheetTime">
                          12.19 pm Friday{" "}
                        </span>
                        <span className="desc seeTimesheetTime">
                          WordPress Developer to Build Website
                        </span>
                      </div>
                    </div>
                    <div className="right">
                      <div className="call_icon messageTopIcon">
                        <svg
                        ...
                        >
                          <path
                            id="info"
                            d="M11.895,0A11.895,11.895,0,1,0,23.789,11.895,11.9,11.9,0,0,0,11.895,0ZM10.408,10.408a1.487,1.487,0,0,1,2.974,0v7.434a1.487,1.487,0,0,1-2.974,0Zm1.487-2.95a1.487,1.487,0,1,1,1.488-1.487A1.487,1.487,0,0,1,11.895,7.458Z"
                            fill="#aaa"
                          />
                        </svg>
                      </div>
                  ...
                  <div className="actions">
                    ...
                    <div className="btns">
                      Add a to-do
                      <span className="seeTimeSheetNewBtnSpan">
                        <button className="seeTimeSheetNewBtn">New</button>
                      </span>
                    </div>
                  </div>
                  <div className="message no-border">
                    ...
                    <div className="right">
                      <div className="msg col-lg-9">
                        Our motivation is to enable computerized connections
                        through versatility. By planning and creating custom
                        applications and portable responsive…
                      </div>
                      <div className="messageTime">
                        <span>12.02 PM : July 20, 2020 </span>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-12 d-flex justify-content-end">
                    <div className="message no-border col-lg-8 d-flex flex-row-reverse">
                      <div className="left">
                        <div className="img">
                          <img src="/assets/PRO-2.png" alt="" />
                        </div>
                  ...
                  <div className="message">
                    ...
                    <div className="right">
                      <div className="msg col-lg-9">
                        Hi Saara Have you check that link
                      </div>
                      <div className="messageTime">
                        <span>12.02 PM : July 20, 2020 </span>
                      </div>
