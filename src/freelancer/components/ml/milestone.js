    ...
    return (
        <>
            ...
            <div className="tg_mile_ml_new">
                <div>Milestones (1)</div>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 13.718 7.843">
                        <path id="Icon_ionic-ios-arrow-down" data-name="Icon ionic-ios-arrow-down" d="M13.049,16.725l5.187-5.191a.976.976,0,0,1,1.385,0,.989.989,0,0,1,0,1.389L13.743,18.8a.979.979,0,0,1-1.352.029L6.473,12.927a.98.98,0,1,1,1.385-1.389Z" transform="translate(-6.188 -11.246)" />
                    </svg>
                </div>
            </div>
            <div className="pt-4 pb-2 d-flex justify-content-between align-items-center flex-wrap">
                <div className="ad_earning-node">Additional earnings and adjustments</div>
                <div className="d-flex justify-content-between align-items-center flex-wrap adtime_txtccwd">
                    Last 30 days:$0.00
                    <div className="toggle_btn_dot">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2D2D2D" className="bi bi-calendar2-date" viewBox="0 0 16 16">
            ...
            <div className="no_txn_box_nwdi">No Transactions Meet your selected criteria</div>
        </>
    )
}
