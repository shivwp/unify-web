            ...
            <Row>
                <Col md={8}>
                    ...
                    <div className="mess_box_cw">
                        <div className="mess_prof_cw"><img src="/assets/PRO-2.png" alt="" /></div>
                    ...
                    <div className="mess_footer_cm">
                        <button className="link_btn_mfc">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#6D2EF1" className="bi bi-link-45deg" viewBox="0 0 16 16">
                        ...
                        <div className="file_bx_mfgb d-flex justify-content-between align-align-items-center">
                            <div className="d-flex">
                                <div className="fiel_con">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#6D2EF1" className="bi bi-file-earmark-text" viewBox="0 0 16 16">
