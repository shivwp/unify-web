                    ...
                    <Col lg={3}>
                        <div className="border_bx_sec">
                            ...
                            <div className='my_skill_sec'>
                                <div className='my_skil_head'><h3>My Skills</h3></div>
                                <div className='prr_box'>
                                    <div className='d-flex justify-content-between'>
                                        <div className='skil_nam'><p>Graphich Designer</p></div>
                                        <div className="skil_rr"><p>60%</p></div>
                                    </div>
                                    <div className='prr_area_line'></div>
                                </div>
                                <div className='prr_box'>
                                    <div className='d-flex justify-content-between'>
                                        <div className='skil_nam'><p>Front End Developer</p></div>
                                        <div className="skil_rr"><p>60%</p></div>
                                    </div>
                                    <div className='prr_area_line'></div>
                                </div>
                                <div className='prr_box'>
                                    <div className='d-flex justify-content-between'>
                                        <div className='skil_nam'><p>Video Editor</p></div>
                                        <div className="skil_rr"><p>60%</p></div>
                                    </div>
                                    <div className='prr_area_line'></div>
                                </div>
                            ...
                            <div className='award_sec'>
                                <div className="my_skil_head"><h3>Awards and Certificates</h3></div>
                                <div className="row">
                                    {Listaward()}
                                </div>
                            </div>
