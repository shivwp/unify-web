...
const Screen = () => {
    ...
    const Tbl = () => {
        const options1 = [
            { value: "Show Contract grouped by day ", label: "Show Contract grouped by day " }
        ];
        return (
            <>
                ...
                <div>
                    <table className="report_tbl_frl">
                        <thead>
                            <tr>
                                <th className="w-50">Contract + Talent</th>
                    ...
                    <table className="report_tbl_frl">
                        <tbody>
                            <tr>
                                <td className="w-50">
                                    <div className='d-flex align-items-center'>
                                        <div className="tbl_profile_frl"><img src="/assets/PRO-2.png" alt="" /></div>
                                        <div>
                                            <div className="tbl_pfrl_name">001-EdTech Coding web App for Teens in Gatsby Zenbit</div>
                            ...
                            <tr>
                                <td className="w-50">
                                    <div className='d-flex align-items-center'>
                                        <div className="tbl_pfrl_name">Total For Mon, Feb 1, 2021</div>
                                    </div>
                                </td>
                                <td className="w-10">8:00</td>
                                <td className="w-15 amount_tr_frl">20.00</td>
                ...
                <div className="main_hirefreelancer_bx main_box_descr pl-0 pr-0">
                    <div className='d-flex justify-content-between flex-wrap mb-3 mt-3 p_my_report32'>
                        <div className="flex_m_j_t pb-0 pt-0 m-0">
                            <div className="my_jo_headin mjh_new_smtext">Weekly summary </div>
                        </div>
                        <div className="d-flex flex-wrap align-items-center">
                            ...
                            <div className="toggle_btn_dot">
                                <button className="toggle_btn_dot">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#7E6E9F" className="bi bi-file-earmark-text-fill" viewBox="0 0 16 16">
