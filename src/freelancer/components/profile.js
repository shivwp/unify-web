...
const Star = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" width="12.754" height="12.165" viewBox="0 0 12.754 12.165">
        <path id="Path_4730" data-name="Path 4730" d="M8.011,7.947l-4.023.446a.384.384,0,0,0-.321.262.378.378,0,0,0,.107.4c1.2,1.091,2.993,2.725,2.993,2.725s-.493,2.377-.82,3.963a.385.385,0,0,0,.15.386.379.379,0,0,0,.411.021c1.408-.8,3.517-2,3.517-2l3.516,2a.381.381,0,0,0,.562-.408c-.327-1.587-.818-3.964-.818-3.964l2.993-2.723a.385.385,0,0,0,.107-.4.381.381,0,0,0-.321-.26c-1.61-.18-4.024-.447-4.024-.447L10.373,4.259a.386.386,0,0,0-.348-.225.381.381,0,0,0-.346.225C9.011,5.734,8.011,7.947,8.011,7.947Z" transform="translate(-3.649 -4.034)" fill="#6d2ef1" />
      </svg>
    </>
  )
}
const CloseIcon = ()=>{
  return <svg fill="#B2B2B2" class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-1om0hkc" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="CloseIcon"><path d="M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path></svg>
}
const WorkHistory = () => {
  return (
    <>
      <div className="work_historycard">
        <div className="whtroy_head">Experienced Developer for Wellenss App</div>
          ...
          <div className="myskill_hdingn m-0">
            <button>
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                <path id="_3180660_share_sharing_social_icon" data-name="3180660_share_sharing_social_icon" d="M15.906,6.906a3.08,3.08,0,0,0-2.458,1.236l-6.395-3.2a3.051,3.051,0,0,0,.134-.851,3.126,3.126,0,1,0-.636,1.858l6.395,3.2a2.769,2.769,0,0,0,0,1.7l-6.395,3.2a3.078,3.078,0,1,0,.636,1.858,3.052,3.052,0,0,0-.134-.851l6.395-3.2a3.088,3.088,0,1,0,2.458-4.951ZM4.094,6.063A1.969,1.969,0,1,1,6.063,4.094,1.971,1.971,0,0,1,4.094,6.063Zm0,11.813a1.969,1.969,0,1,1,1.969-1.969A1.971,1.971,0,0,1,4.094,17.875Zm11.813-5.906A1.969,1.969,0,1,1,17.875,10,1.971,1.971,0,0,1,15.906,11.969Z" transform="translate(-1 -1)" fill="#6d2ef1" />
              </svg>
            </button>
          </div>
        </div>
        <div className="whistory_para">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing</div>
        ...
        <div className="popup_box_bpn profile_nceqoi_popup pb-4">
          ...
          <div className="popup_body_bpn amount_popup_body max_height_popucwui overflow-scroll">
            ...
            <div className='catbox_rd_ofive mt-3'>
              ...
              <div>
                <input type='text' placeholder="search here skills..." className='no-border font-size-13px search_skilloiouo'/>
              </div>
            </div>
      ...
      <Container>
        <Row>
          ...
          <Col lg={9}>
            ...
            <div className="box-profile-bck mb-0">
              <div className="bpbck_txt d-flex mt-0">
                <div className="bpck_head font-weight-500 line-height-30">Work History</div>
              </div>
              <div>
                <div className='tabbar_profle'>
                  <button className="activetabbar_btn">Commpleted Jobs (2)</button>
                    ...
                    <div className="delivery_time_bckp mt-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20.75" height="20.75" viewBox="0 0 20.75 20.75">
                        <g id="Icon_ionic-md-time" data-name="Icon ionic-md-time" transform="translate(-3.375 -3.375)" opacity="0.56">
                          ...
                          <path id="Path_4755" data-name="Path 4755" d="M18.094,10.688H16.538v6.225l5.447,3.267.778-1.277-4.669-2.768Z" transform="translate(-3.825 -2.125)" fill="rgba(0,0,0,0.9)" />
                        </g>
                      </svg>
                      4 days delivery</div>
                  </div>
            ...
            <Row>
              <Col md={6}>
                <div className="box-profile-bck minei400">
                  ...
                  <div className="bpbck_txt">
                    <div className="bpck_head font-weight-600">Employment history</div>
                  </div>
                  <div className="d-flex justify-content-center flex-column pl-20">
                    <div className="bpck_sm_txt_a mt-4 ehistory_uxdes">UI/UX Designer | Expert Web Technplogies</div>
                    <div className="ehitory_dtine">January 2019 - February 2021</div>
                    <div className="bpck_sm_txt_a mt-4 mb-0">
                      <div className="d-flex myskill_hdingn mb-0">
                        <button className="m-0">
                          <svg xmlns="http://www.w3.org/2000/svg" width="15.709" height="15.714" viewBox="0 0 15.709 15.714">
                            <path id="_8665767_pen_icon" data-name="8665767_pen_icon" d="M15.327,2.274,13.482.429a1.475,1.475,0,0,0-2.085,0L9.662,2.165l3.9,3.929L15.3,4.358A1.447,1.447,0,0,0,15.327,2.274Zm-6.356.585L1,10.83a.491.491,0,0,0-.134.251L.057,15.123a.491.491,0,0,0,.576.58l4.042-.808a.491.491,0,0,0,.251-.134L12.9,6.789Z" transform="translate(-0.047 0.002)" fill="#6d2ef1" />
                          </svg>
                        </button>
                        <button>
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            <path id="_2203546_bin_delete_gabage_trash_icon" data-name="2203546_bin_delete_gabage_trash_icon" d="M8,0A1,1,0,0,0,7,1H0V3H1V14a2,2,0,0,0,2,2H13a2,2,0,0,0,2-2V3h1V1H9A1,1,0,0,0,8,0ZM4,14H3V5H4Zm3,0H6V5H7Zm3,0H9V5h1Zm3,0H12V5h1Z" fill="#6d2ef1" />
                          </svg>
                        </button>
                      </div>
                    </div>
              ...
              <Col md={6}>
                <div className="box-profile-bck minei400">
                  ...
                  <div className="bpbck_txt">
                    <div className="bpck_head font-weight-600">Other Experiences</div>
                  </div>
                  <div className="d-flex justify-content-center flex-column text-center">
