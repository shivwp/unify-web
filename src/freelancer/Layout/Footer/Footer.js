                    ...
                    <Col lg={3}>
                        ...
                        <div>
                            <ul className="footer_ul">
                                ...
                                <li><Link to="/">Programming & TechLifestyle</Link></li>
                            </ul>
                        </div>
                    </Col>
                    <Col lg={3}>
                        ...
                        <div>
                            <ul className="footer_ul">
                                ...
                                <li><Link to="/">Intellectual Claims</Link></li>
                    ...
                    <Col lg={3}>
                        ...
                        <div>
                            <ul className="footer_ul">
                                ...
                                <li><Link to="/">Selling on Unify</Link></li>
                                <li><Link to="/">Buying on Unify</Link></li>
                            </ul>
                        </div>
                    </Col>
                    <Col lg={3}>
