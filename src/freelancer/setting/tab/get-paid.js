                ...
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="s_nav_body">
                            <div className="s_b_head no-border"><h2>Get Paid</h2></div>
                                ...
                                <Row>
                                    <Col lg={12} className="d-flex justify-content-between pt-2 pb-3 flex-wrap">
                                        <div className='d-flex mb-2 mt-3 justify-content-between w-100'>
                                            <div className="w-55">
                                                <div className='c_name_s_v'>You have not set up any payment methods yet.</div>
                                                <div className="c_name_sett pt-0 font-color-light">Tell us how you want to receive your funds. It may take up to 3 days to activate your payment method.</div>
                                            </div>
                                        </div>
                                    </Col>
                                </Row>
