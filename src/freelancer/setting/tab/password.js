            ...
            <div className="popup_body_bpn amount_popup_body max_height_popucwui overflow-scroll">
              ...
              <div className='mb-3'>
                <div className="popup_form_element agrement_ineoeu mt-3 pt-1">
                  ...
                  <label className='text-black font-size-13px font-weight-500 mt-1 pb-1 radiolablepopo'><input type='radio' name="g"/>  Mobile app prompt</label>
                  <label className='text-black font-size-13px font-weight-500 mt-1 pb-1 radiolablepopo'><input type='radio' name="g"/>  Text message</label>
                </div>
              </div>
              <div className='mb-4'>
                <div className="popup_form_element agrement_ineoeu mt-3 pt-1">
                  ...
                  <label className='text-black font-size-13px font-weight-500 mt-1 pb-1 radiolablepopo'><input type='radio' name="g"/>  At every login and when my login or activity seems risky</label>
                </div>
              </div>
                        ...
                        <div className="s_nav_body">
                            ...
                            <div className="r-box_setting">
                                <div className="d-flex justify-content-between align-items-center b-bottom-gr pt-1 pb-3">
                                    ...
                                    <div>
                                        <button className="round_b_btn"  onClick={() => { Setpopup(<ChangePassword Popup={Setpopup} />) }}>
                                ...
                                <div className='d-flex justify-content-between'>
                                    <div className="d-flex">
                                        <div>
                                            ...
                                            <div className='user_mal_set pl-0'>Choose a strong, unique password that’s at least 8 characters long.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="r-box_setting">
                                <div className="d-flex justify-content-between align-items-center b-bottom-gr pt-1 pb-3">
                                    <div>
                                        <div className='setting_b_head_s'>Two-step verification options</div>
                                        <div className='user_mal_set pl-0'>Add an extra layer of security to block unauthorized access and protect your account.</div>
                                    </div>
                                    <div>
                                        <button className="round_b_btn"  onClick={() => { Setpopup(<VerificationPref Popup={Setpopup} />) }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#D4D4D5" className="bi bi-pencil-square" viewBox="0 0 16 16">
                                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                <path fillRule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                            </svg>
                                ...
                                <div className='d-flex justify-content-between b-bottom-gr pb-2'>
                                    <div className="d-flex">
                                        <div>
                                            <div className='user_nme_set pl-0 span_s_fon'>Authenticator app code<span>(Recommended)
                                            ...
                                            <div className='user_mal_set pl-0'>Enter a code generated by your authenticator app to confirm it’s you.</div>
                                        </div>
                                    </div>
                                ...
                                <div className='d-flex justify-content-between b-bottom-gr pb-2'>
                                    <div className="d-flex">
                                        <div>
                                            <div className='user_nme_set pl-0 span_s_fon'>Mobile app prompt<span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-question-circle-fill" viewBox="0 0 16 16">
                                                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.496 6.033h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286a.237.237 0 0 0 .241.247zm2.325 6.443c.61 0 1.029-.394 1.029-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94 0 .533.425.927 1.01.927z" />
                                                </svg>
                                            </span></div>
                                            <div className='user_mal_set pl-0'>Receive a prompt from your mobile app to confirm it’s you.</div>
                                        </div>
                                    </div>
                                    <div className='d-flex justify-content-center align-items-center'>
                                        <Switch
                                ...
                                <div className='d-flex justify-content-between b-bottom-gr pb-2'>
                                    <div className="d-flex">
                                        <div>
                                            <div className='user_nme_set pl-0 span_s_fon'>Text message<span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-question-circle-fill" viewBox="0 0 16 16">
                                                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.496 6.033h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286a.237.237 0 0 0 .241.247zm2.325 6.443c.61 0 1.029-.394 1.029-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94 0 .533.425.927 1.01.927z" />
                                                </svg>
                                            </span></div>
                                            <div className='user_mal_set pl-0'>Receive a six digit code by text message to confirm it’s you.</div>
                                        </div>
                                    </div>
                                    <div className='d-flex justify-content-center align-items-center'>
                                        <Switch
                                ...
                                <div className='d-flex justify-content-between pb-2'>
                                    <div className="d-flex">
                                        <div>
                                            <div className='user_nme_set pl-0 span_s_fon'>Security question<span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-question-circle-fill" viewBox="0 0 16 16">
                                                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.496 6.033h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286a.237.237 0 0 0 .241.247zm2.325 6.443c.61 0 1.029-.394 1.029-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94 0 .533.425.927 1.01.927z" />
                                                </svg>
                                            </span></div>
                                            ...
                                            <div className='user_mal_set pl-0'>Answer a question you choose to confirm it’s you.</div>
                                        </div>
                                    </div>
                                    <div className='d-flex justify-content-center align-items-center'>
                                        <div>
