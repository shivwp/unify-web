              ...
              <div className="sep_bdr">
                    ...
                    <Col lg={8} md={8}>
                      <div className="left">
                        ...
                        <div className="description">
                          ...
                          looking at its layout. hello bro, how are you
                        </div>
                ...
                <div className="terms">
                  <div className="head">
                    ...
                    <div className="budget">Client's budget: $12</div>
                  </div>
                  ...
                  <div className="message">
                    ...
                    <div className="right">
                      ...
                      <div className="msg">
                        ...
                        can you please some competitor website so i can have
                        more details?
                        <br />
                        Thank You.
                      </div>
              ...
              <div className="sep_bdr" style={{ borderRadius: 10 }}>
                <div className="about_client">
                  ...
                  <div className="reviews">
                    {<StarRating rating={2} />}
                    <div className="desc">4 of 24 reviews</div>
                  </div>
                  <div className="location">
                    <div className="headingl">Location</div>
                    <div className="country">India</div>
                    <div className="timezone">12.00 AM</div>
                  </div>
                  <div className="history">
                    <div className="headingh">History</div>
                    <div className="desc"> 12 proposals</div>
                    <div className="desc">2 interviews</div>
                    {/* <div className="desc">$1096 total spent</div> */}
                    <div className="desc">111 jobs</div>
                    <div className="desc">1 total hires</div>
                    <div className="desc">77% hire rate</div>
                  </div>
                  <div className="member_since">Member since 12/Oct/2022</div>
                </div>
              </div>
            </Col>
          </Row>
...
export default ViewOriginalProposal;
