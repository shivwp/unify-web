      ...
      <Col lg={9}>
        <div className="s_nav_body">
          ...
          <div className="set_tem_para_s">
            Teams let you organize contracts by department or manager. Use them
            to simplify your reporting, permission, and recruiting management.
          </div>
            ...
            <div className="r-box_setting">
              ...
              {teamList?.map((item) => (
                <div className="s_tble_s width-max-content-s menu_btn">
                  ...
                  <div className="s_th_s s_td_s w-20">{item.po_number}</div>
                  <div
