      ...
      <div className="col-lg-8 col-md-7">
        <div className="milestone_timeline">
          ...
          <div className="timeline">
            ...
            <div className="progress_steps" id="progress_step1">
              ...
              <div className="about_step">
                <div className="timeline_link">Show all Completed</div>
              </div>
            </div>
            <div className="progress_steps" id="progress_step2">
              <div className="fill_ filled_background">2</div>
              <div className="about_step">
                <div className="p_heading">Milestone 6</div>Once the website is
                live done and the code submit to the client
          ...
          <div className="progress_steps" id="progress_step1">
            ...
            <div className="connecting_line"></div>
            <div className="about_step">
              <div className="timeline_link">Propose New Milestone</div>
            </div>
          </div>
          <button className="endContracts-button">Manage Milestone</button>
        </div>
      </div>
