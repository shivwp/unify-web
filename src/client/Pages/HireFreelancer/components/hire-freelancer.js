    ...
    <>
      <Container>
            ...
            <div className="freel_det_bin">
              ...
              <div className="freelancer_exp_in freelancer_loc_in d-flex flex-wrap sm_amhir_no_mar">
                ...
                <div className="amount_hir_in p-0">
                  <b>{singleFreelancer?.basic_info?.success_rate}</b> Job
                  Success
                </div>
              </div>
            </div>
                        ...
                        <div className="method">
                          ...
                          <div>
                            <label htmlFor="multiple" className="heading">
                              Deposit a lesser amount to cover the first
                              milestone
                            </label>
                          </div>
                        </div>
                        ...
                        <>
                          ...
                          <Col lg={12}>
                            <div className="milsetone">
                              ...
                              <p style={{ fontSize: "14px" }}>
                                Add project milestones and pay in installments
                                as each milestone is completed to your
                                satisfaction. Due dates will be set in
                              ...
                              <div className="milestone_count">
                                ...
                                {inputList?.map((data, index) => (
                                  <div className="input_list" key={index}>
                              ...
                              <div className="add_milestone">
                                <span onClick={handleAddMilestone}>
                                  + Add milestone
                                </span>
                              </div>
                            </div>
        ...
        <div className="main_box_descr main_hirefreelancer_bx">
          ...
          <div className="pay_pro_par p-0 m-0">
