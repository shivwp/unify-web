        ...
        <Row>
          ...
          <Col lg={4}>
            <div className="mb-2 mt-1">
              ...
              <div className="c_name_s_v">{getClientDetails?.vat_id}</div>
            </div>
          </Col>
          <Col lg={3}>
            <div className="mb-2 mt-2">
          ...
          <Col lg={3}>
            <div className="mb-2 mt-2">
              <div className="c_name_sett">Country</div>
              <div className="c_name_s_v">{getClientDetails?.country}</div>
            </div>
          </Col>
          <Col lg={3}>
            <div className="mb-2 mt-2">
              <div className="c_name_sett">City</div>
              <div className="c_name_s_v">{getClientDetails?.city}</div>
            </div>
          </Col>
          <Col lg={3}>
            <div className="mb-2 mt-2">
