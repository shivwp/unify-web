                        ...
                        <div className="freelancer_box_area_in">
                            <div className='d-flex justify-content-between flex-wrap'>
                                ...
                                <div className='d-flex align-items-center flex-wrap'>
                                    <button className="transp_fil_btn heart_roun_btn mt-2" onClick={()=>{props.changetab("archive")}}>
                                    ...
                                    <button className="transp_fil_btn mt-2 font-weight-500">Message</button>
                                    <Link to="/hire-freelancer"><button className='mt-2 font-weight-500'>Hire</button></Link>
                                    </div>
                                </div>
                            </div>
