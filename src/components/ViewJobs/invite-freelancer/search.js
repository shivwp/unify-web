        ...
        <>
            <div className='search_area_in'>
                ...
                <div className='ts_btn attach_f_btn wid_30_in'>
                    <button className="transp_fil_btn fif_five">
                        ...
                        Filters</button>
                    <button className='fif_five'>Advanced Search</button>
                </div>
            </div>
                        ...
                        <div className="freelancer_box_area_in">
                            <div className='d-flex justify-content-between'>
                                ...
                                <div className='d-flex align-items-center'>
                                    ...
                                    <button className="transp_fil_btn">Hire</button>
                            ...
                            <div className='freelancer_compl_in'>
                                ...
                                Completed 6 Mobile App Design jobs on Unify</div>
