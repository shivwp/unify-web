...
const Screen = ({ invitedFreelancerList }) => {
  return (
    <>
      {!invitedFreelancerList ? (
        <div className="d-flex justify-content-center flex-column align-items-center py-4">
          ...
          <p>Invite top candidates before they're booked.</p>
        </div>
      ) : (
        <>
          {invitedFreelancerList?.map((data, key) => (
                    ...
                    <div className="d-flex justify-content-between flex-wrap">
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ts_btn attach_f_btn wid_30_in d-flex">
                          <Button
                            variant=""
                            className="transp_fil_btn font-weight-500"
                          >
                            Hire
                          </Button>
                        </div>
