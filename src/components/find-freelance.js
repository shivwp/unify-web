    ...
    <div className="find_frelance">
      <div className="">
        <div className="find-freel-head">
          <div className="zero_one zer_to zero_four">04</div>
          <h1>
            Find <span className="ffh">freelance</span> talent to
            <br /> take on any project
          </h1>
        </div>
            ...
            >
              <SwiperSlide>
                <div className="freelance_card">
                  ...
                  <div className="frel-serv">
                    <p>Professional Editor * Published Writer *</p>
                  </div>
                  <div className="frel_job">
                    <div className="tropee_svg">
                      <img src="/assets/trofee.svg" alt="" />
                    </div>
