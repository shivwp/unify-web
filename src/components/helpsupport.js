...
const Screen = () => {
    ...
    return (
        <>
                    ...
                    <Row>
                        <Col lg={3}>
                            <div className="help_box_h">
                                <div className="help_icon_rou">
                                    <svg className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-1om0hkc" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="RocketLaunchIcon"><path d="M9.19 6.35c-2.04 2.29-3.44 5.58-3.57 5.89L2 10.69l4.05-4.05c.47-.47 1.15-.68 1.81-.55l1.33.26zM11.17 17s3.74-1.55 5.89-3.7c5.4-5.4 4.5-9.62 4.21-10.57-.95-.3-5.17-1.19-10.57 4.21C8.55 9.09 7 12.83 7 12.83L11.17 17zm6.48-2.19c-2.29 2.04-5.58 3.44-5.89 3.57L13.31 22l4.05-4.05c.47-.47.68-1.15.55-1.81l-.26-1.33zM9 18c0 .83-.34 1.58-.88 2.12C6.94 21.3 2 22 2 22s.7-4.94 1.88-6.12C4.42 15.34 5.17 15 6 15c1.66 0 3 1.34 3 3zm4-9c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2z"></path></svg>
                                </div>
                        ...
                        <Col lg={3}>
                            <div className="help_box_h">
                                ...
                                <div className="help_val_h">Post A Job, Find A Freelancer Or Agency, Invite To Apply</div>
                            </div>
                        </Col>
                        <Col lg={3}>
                            <div className="help_box_h">
                                ...
                                <div className="help_val_h">Evaluate Proposals, Interview Freelancers, Send An Offer</div>
                            </div>
                        </Col>
                        <Col lg={3}>
                            <div className="help_box_h">
                                ...
                                <div className="help_val_h">Manage Contracts, Contracts, Feedback</div>
                            </div>
                        </Col>
                        <Col lg={3}>
                            <div className="help_box_h">
                                ...
                                <div className="help_val_h">Billing, Make Payment, Reports, Invoices, Disputes</div>
                            </div>
                        </Col>
                        <Col lg={3}>
                            <div className="help_box_h">
                                ...
                                <div className="help_val_h">Unify Basic, Unify Pro, Unify Enterprise</div>
                            </div>
                        </Col>
                        <Col lg={3}>
                            <div className="help_box_h">
                                ...
                                <div className="help_val_h">Account Settings, Manage Teams, Team Permissions</div>
                            </div>
                        </Col>
                        <Col lg={3}>
                            <div className="help_box_h">
                                ...
                                <div className="help_val_h">Mobile App, Desktop App, Time Tracker</div>
                            </div>
                        </Col>
                        <Col lg={3}>
                            <div className="help_box_h">
                                ...
                                <div className="help_val_h">Terms Of Service, Online Safety, Personal Data</div>
                            </div>
                        </Col>
                        <Col lg={3}>
                            <div className="help_box_h">
                        ...
                        <Col lg={3}>
                            <div className="help_box_h">
                                ...
                                <div className="help_val_h">Announcement Of New Features, Services And More</div>
                            </div>
                        </Col>
                    </Row>
                </Container>
                        ...
                        <Col lg={3}>
                            <div className="acc_bxo_h">
                                <div className="acc_icon_h">
                                    <svg className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-1om0hkc" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="RequestQuoteIcon"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm1 10h-4v1h3c.55 0 1 .45 1 1v3c0 .55-.45 1-1 1h-1v1h-2v-1H9v-2h4v-1h-3c-.55 0-1-.45-1-1v-3c0-.55.45-1 1-1h1V9h2v1h2v2zm-2-4V3.5L17.5 8H13z"></path></svg>
                                </div>
            ...
            <div className="bg-gray_bd">
                <Container>
                    <div className="browse_head_h mt-30-px">Learn More About What’s New At Unify</div>
                    <div className="btn_foot_sec justify-content-center flex-wrap no-border fo_btn_c mb-0 pb-0 next_b_btn_c"   >
                        <button className="active_btn_blue mi-width-2 pnew">Learn More</button>
                    </div>
