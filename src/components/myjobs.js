                ...
                <Row>
                    ...
                    <Col lg={3}>
                        ...
                        <ul className="filter_ul_m">
                            ...
                            <li><input type="radio" /> Invite only</li>
                            <li><input type="radio" /> Public</li>
                        </ul>
                    </Col>
                    <Col lg={3}>
                        ...
                        <ul className="filter_ul_m">
                            ...
                            <li><input type="checkbox" /> Filled</li>
    ...
    const Jobs = () => {
        return (
            <div className='my_job_flx'>
                <div>
                    <div className="my_job_a"><a href="#0">UI/UX Design</a></div>
                ...
                <div className='text-right d-flex flex-wrap'>
                    <button className="blue_btn_smm">View Proposals</button>
        ...
        <>
            <Container>
                <div className='flex_m_j_t b-bottom-gr'>
                    ...
                    <div className='post_job_btn_m'><button>Post A New Job</button></div>
                </div>
                <div className="main_hirefreelancer_bx main_box_descr">
                    <div className='search_area_in b-bottom-gr pb-2'>
                        ...
                        <div className='ts_btn attach_f_btn wid_30_in'>
                            <button className="transp_fil_btn fif_five" onClick={() => { ToggleFilter() }}>
