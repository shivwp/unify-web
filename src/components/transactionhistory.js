            ...
            <>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        <div className="d-flex justify-content-between align-items-center contract_sel">
                            <div className='select_inp_in filter_select_m'>
                                <select>
                                    ...
                                    <option>All Debits All Credits</option>
                        ...
                        <div className='download_lnk_csx'>
                            <div className="btn_foot_sec justify-content-center flex-wrap no-border m-0 p-0">
                                <div className='fo_btn_c next_b_btn_c'><button className="active_btn_blue">Apply</button></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="no_found_cen">
                    <div>
                        ...
                        <div className="no_foun_head_ce"><h1>No transactions meet your selected criteria</h1></div>
                    </div>
                </div>
            </>
        )
    ...
    return (
        <>
            <Container>
                ...
                <div className='trans_h_b_n'>Balance: <span>$0.00</span></div>
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-0 mt-0 pb-0">
                        ...
                        <div className='download_lnk_csx'>
                            <div className="btn_foot_sec p-0 justify-content-center flex-wrap no-border mt-2">
                                <div className='fo_btn_c next_b_btn_c'><button className="hideen_csv_do_btn">Download CSV</button></div>
                                <div className='fo_btn_c next_b_btn_c'><button className="hideen_csv_do_btn">Download Invoinces</button></div>
                            </div>
                        </div>
                    </div>
                    {open}
