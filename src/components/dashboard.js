            ...
            <Container>
                <div className='flex_m_j_t pt-4 pb-4 flex-wrap'>
                    ...
                    <div className='post_job_btn_m d-flex align-items-center flex-wrap'>
                        ...
                        <Link to="/gettingstarted"><button className='mt-2 border_blue_wwifth'>Post A Job</button></Link>
                        <Link to="/expandteam"><button className="ml_btn trans_btn_myjo blue_coloe_brn mt-2">
                ...
                <div className='yourp_box pb-0 pt-3'>
                    <div className='d-flex justify-content-between align-items-center pb-3 b-bottom-gr' onClick={(e) => hanDleSlide(e)}>
                        ...
                        <div><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-down" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"></path></svg></div>
                        </div>
                    </div>
