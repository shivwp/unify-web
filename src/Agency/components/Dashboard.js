            ...
            <Col lg={3}>
              ...
              <div>
                ...
                <div className="des_para_dboadr">
                  ...
                  Covers, Flex/Hoarding, and App Icons. On the off chance that
                  you need HIGH-QUALITY work with a FAST TURNAROUND, reach me.
                  100% .
                </div>
              </div>
                ...
                <Col lg={4} className="mt-2 mb-4">
                  <div>
                    ...
                    <div className="recome_blextxt">
                      Need a designer to from branding essentials for my
                      business.
                    </div>
